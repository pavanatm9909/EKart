...
class SellerRepositoryTest {
	...
	public void setUp() {
		seller = new Seller();
		seller.setEmailId("jerry1992@gmail.com");
	...
	void findByIdValidTest() {
		sellerRepository.save(seller);
		Optional<Seller> optionalSeller = sellerRepository.findById("jerry1992@gmail.com");
		Assertions.assertTrue(optionalSeller.isPresent());
	}
	...
	void saveInvalidTest() {
		sellerRepository.save(seller);
		Optional<Seller> optionalSeller = sellerRepository.findById("tom1992@gmail.com");
	...
	void getPasswordOfSellerValidTest() {
		sellerRepository.save(seller);
		String passwordFromDB = sellerRepository.getPasswordOfSeller("jerry1992@gmail.com");
