...
class CustomerRepositoryTest {
	...
	public void setUp() {
		...
		customer.setEmailId("fahad@gmail.com");
	...
	void saveCustomerValidTest() {
		...
		Assertions.assertEquals("fahad@gmail.com", customerFromDB.getEmailId());
	}
	...
	void findByIdCustomerValidTest() {
		...
		Optional<Customer> optionalCustomer = customerRepository.findById("fahad@gmail.com");
